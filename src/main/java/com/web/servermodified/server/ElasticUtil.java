package com.web.servermodified.server;
...
public class ElasticUtil {
   ...
   public static StringBuilder indexFieldList(String indexSite , String index) {
     ...
     * @return
     */
    public static String indexFieldString(String indexSite , String index) {
        CloseableHttpClient client = HttpClients.createDefault();
        HttpGet get = new HttpGet(indexSite);
        CloseableHttpResponse httpResponse = null;
        String content = null;
        try {
            ...
            String key = o3.entrySet().iterator().next().getKey();
            JSONObject o4 = o3.getJSONObject(key);
            content = o4.getString("properties");
        } catch (IOException e) {
            e.printStackTrace();
        }
        return content;
    ...
    /**
     * 根据 url  获取 es服务的 单条记录
     * @param url
     * @return
     */
    public static String indexFirstInfo(String url) {
        String content = null;
        CloseableHttpClient client = HttpClients.createDefault();
